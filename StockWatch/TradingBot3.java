public class TradingBot3 { 
    double balance; 
    int sharesOwned = 0; 
    double entry = 0; 
    double previousRSI = 0; 
    private int MA_PERIOD = 50; 
    public TradingBot3(double initialBalance) { 
    ...
    public void tradeMaker(StockReader stockBot, int currentIndex) { 
        ...
        if (currentRSI < previousRSI && sharesOwned == 0) { 
            ...
            sharesOwned = 0; entry = 0; 
        } else { 
            System.out.println("No trade executed."); } previousRSI = currentRSI; } }